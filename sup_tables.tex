...
\centering
	...
	\caption[Per-texture accuracies using the concatenation layer]{Per-texture accuracies using the concatenation layer. Each texture accuracy includes a margin of error with a $95\%$ statistical confidence.}
...
\begin{table*}
	...
	\caption[Per-texture accuracies using the flow decode layer]{Per-texture accuracies using the flow decode layer. Each texture accuracy includes a margin of error with a $95\%$ statistical confidence.}
...
\begin{table*}
	...
	\caption[Accuracies of textures grouped by appearances, using the concatenation layer]{Accuracies of textures grouped by appearances, using the concatenation layer. Each texture accuracy includes a margin of error with a $95\%$ statistical confidence.}
...
\begin{table*}
	...
	\caption[Accuracies of textures grouped by appearances, using the flow decode layer]{Accuracies of textures grouped by appearances, using the flow decode layer. Each texture accuracy includes a margin of error with a $95\%$ statistical confidence.}
...
\begin{table*}
	...
	\caption[Accuracies of textures grouped by dynamics, using the concatenation layer]{Accuracies of textures grouped by dynamics, using the concatenation layer. Each texture accuracy includes a margin of error with a $95\%$ statistical confidence.}
...
\begin{table*}
	...
	\caption[Accuracies of textures grouped by dynamics, using the flow decode layer]{Accuracies of textures grouped by dynamics, using the flow decode layer. Each texture accuracy includes a margin of error with a $95\%$ statistical confidence.}
...
\begin{table*}
	...
	\caption[Average accuracy over all textures, using the concatenation layer]{Average accuracy over all textures, using the concatenation layer. Each texture accuracy includes a margin of error with a $95\%$ statistical confidence.}
...
\begin{table*}
	...
	\caption[Average accuracy over all textures, using the flow decode layer]{Average accuracy over all textures, using the flow decode layer. Each texture accuracy includes a margin of error with a $95\%$ statistical confidence.}
