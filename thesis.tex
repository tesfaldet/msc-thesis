...
\usepackage[pagebackref=true,breaklinks=true,letterpaper=true,colorlinks,hidelinks,bookmarks=false]{hyperref}
\hypersetup{
    linkcolor = {}
}
...
\DeclareRobustCommand\highlight[1]{\textcolor{blue}{#1}}
